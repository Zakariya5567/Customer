import 'dart:convert';
import 'dart:io';
import 'package:customer/Models/create_order_model.dart';
...
class CreateOrderApi {
  ...
  createOrderApi(data) async {
    ...
    String createOrderUrl = ApiUrl.createOrderUrl;

    print(createOrderUrl);

    var response = await http.post(Uri.parse(createOrderUrl),body:data, headers: headers);
    ...
    createOrderModel = CreateOrderModel.fromJson(decodeResponse);
